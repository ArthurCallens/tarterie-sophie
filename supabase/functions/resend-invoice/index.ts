...
// email was wrong, she corrected it, and now wants to force a fresh send.
// Unlike the automatic Postgres-webhook path (invoice-webhook), this always
// regenerates the PDF with the order's current data and always sends,
// bypassing the "already sent" idempotency guard in generate-invoice-and-send.
//
